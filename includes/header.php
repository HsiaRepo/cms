...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="css/bootstrap.min.css" rel="stylesheet"> <!-- TODO ?: Resolution issue -->

    <!-- Custom CSS -->
    <link href="css/blog-home.css" rel="stylesheet"> <!-- TODO ?: Resolution issue -->

    <!-- Internet Explorer scripts based on conditional comment -->
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!-- TODO ?: Locally Stored Library issue(s) -->
    <!--[if lt IE 9]>
